...
class EscapeHuskSimpleRewardWrapper(gym.Wrapper):
    def __init__(self):
        ...
        super(EscapeHuskSimpleRewardWrapper, self).__init__(self.env)
...
def main():
    env = EscapeHuskSimpleRewardWrapper()
    buffer_size = 1000000
    batch_size = 256
    gamma = 0.99
    learning_rate = 0.001
    ...
    runner = WrapperRunner(
        env,
        "EscapeHuskWrapper-6Actions-Simple",
        agent=agent,
