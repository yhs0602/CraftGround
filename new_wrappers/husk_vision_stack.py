...
def main():
    env = HuskVisionStackWrapper(verbose=False)
    ...
    policy_net = CNNDQNStacked(state_dim, action_dim, kernel_size)
    target_net = CNNDQNStacked(state_dim, action_dim, kernel_size)
